...
startShrinkRayBuild({
  ...
  // the following does not apply since this repo does not use build kite.
  buildkiteBuild: process.env.TRAVIS_JOB_WEB_URL || '',
  buildkitePipeline: process.env.TRAVIS_BUILD_WEB_URL || '',
});
